                    ...
                    <div class="form-horizontal col-xs-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                ...
                                <input type="hidden" class="form-control" name="mess" value="{{ isset($calculos['mes']) ? $calculos['frete'] : '0' }}" />
                                ...
                                <input type="hidden" class="form-control" name="ValTaxPag2Dias" value="{{ isset($calculos['v2tDias']) ? $calculos['v2tDias'] : '0' }}" />
