			...
			<div class="col-xs-12">
				...
				<form class="form-horizontal" method="post" action="{{route('membros.store')}}">
					...
					<div class="form-group">
						...
						<div class="col-xs-2">
							<input type="text" class="form-control phone" name="fone" placeholder="Ex.: (00) 0000-0000" size=14/>
						</div>
						<label for="emer" class="col-xs-1">Contato Emergência:</label>
						<div class="col-xs-2">
							<input type="text" class="form-control phone" name="foneEmerg" placeholder="Ex.: (00) 0000-0000" size=14/>
						</div>
					</div>
